...
public partial class updateEvent : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            SqlCommand myCommand = new SqlCommand("SELECT EVENT_DETAILS.EventId, EVENT_DETAILS.VenueId, EVENT_DETAILS.DATE, EVENT_DETAILS.NoOfGuests, ITEM_DETAILS.Food, ITEM_DETAILS.Decoration,ITEM_DETAILS.Music,ITEM_DETAILS.Cake FROM EVENT_DETAILS INNER JOIN ITEM_DETAILS ON EVENT_DETAILS.UserId = ITEM_DETAILS.UserId ", conn);
